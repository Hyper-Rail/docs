...
---
### API Key Management
HyperRails provides two types of API keys for different use cases: public keys and secret keys. You can manage these keys from your HyperRails dashboard.
...
All server-side API requests to HyperRails must be authenticated using your secret key. Here's how to authenticate:
