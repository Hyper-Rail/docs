...
description: Convert fiat currency into stablecoins using HyperRails’s on-ramp feature.
icon: 'arrow-up'
---
...
On-ramp transactions allow merchants to **convert fiat currency into stablecoins** directly within the HyperRails application.
...
/>
    Login to your HyperRails account
...
/>
    ...
    HyperRails displays the current exchange rate and expected stablecoin amount.
  </Step>
...
/>
   ...
   1. **Balance**: You can fund using your HyperRails wallet
...
/>
   ...
   1. **HyperRails**: You can recieve funds to your HyperRails wallet 
  ...
  <Step title="Receive Stablecoins">
    Stablecoins are credited to your HyperRails wallet once processing is complete.
  </Step>
</Steps>
