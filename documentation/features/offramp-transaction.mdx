...
description: Convert stablecoins into fiat currency using HyperRails’s off-ramp feature.
icon: 'arrow-down'
---
...
Off-ramp transactions allow merchants to **convert stablecoins into fiat currency** within the HyperRails application.
...
<Steps>
 <Step title="Login">
  ...
  <Step title="Review Rate">
    HyperRails displays the current exchange rate and expected fiat payout.
  </Step>
