...
description: Invite team members to your HyperRails dashboard and manage their access using predefined or custom roles.
icon: users
---

## Overview

HyperRails allows you to **invite team members** to your dashboard and control what they can access using **roles and permissions**.  
...
## How Team Members Access HyperRails
...
HyperRails provides predefined roles with different access levels:
