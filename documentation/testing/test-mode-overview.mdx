...
description: "Understand how HyperRails's test environment works before you start building."
icon: microscope
---

# Test Mode Overview

HyperRails gives you a test environment—called **test mode**—where you can build and verify your integration without touching real money or live accounts.
...
You can toggle between test and live mode directly from your HyperRails dashboard. The toggle is in the top navigation bar.
